...
def adidas_interface():
    """Interface pour Adidas"""
    st.title("🛍️ Analyse des Avis sur les Produits Adidas")
    st.write("Cette application analyse les avis des produits Adidas pour évaluer leur qualité.")
